...
int main(int argc, char* argv[])
{
	...
	FileStorage fs1("mystereocalib123.yml", FileStorage::WRITE);
	fs1 << "CM1" << CM1;
	fs1 << "CM2" << CM2;
	fs1 << "D1" << D1;
	fs1 << "D2" << D2;
	...
	while (1)
	{
		...
		cvtColor(imgU1, imgU1, CV_BGR2GRAY);
		cvtColor(imgU2, imgU2, CV_BGR2GRAY);

		Mat imgDisparity16S = Mat(imgU1.rows, imgU1.cols, CV_16S);
		...
		//sbm.P1 = 600;
		//sbm.P2 = 2400;
		sbm(imgU1, imgU2, imgDisparity16S);
